...
class SetMix(BaseMix):
	async def sadd(self, key, *members):
		return await self.protocol.send(b'SADD', key, *members)

	async def scadd(self, key):
		return await self.protocol.send(b'SCADD', key)

	async def sdiff(self, key, *other_keys):
		return await self.protocol.send(b'SDIFF', key, *other_keys)
	...
	async def sinter(self, key, *other_keys):
		return await self.protocol.send(b'SINTER', key, *other_keys)
	...
	async def sismember(self, key, member):
		return await self.protocol.send(b'SISMEMBER', key, member)

	async def smembers(self, key):
		return await self.protocol.send(b'SMEMBERS', key)

	async def smove(self, source, destination, member):
		return await self.protocol.send(b'SMOVE', source, destination, member)

	async def spop(self, key):
		return await self.protocol.send(b'SPOP', key)
	...
	async def srandmember(self, key, count=None):
		...
		return await self.protocol.send(b'SRANDMEMBER', key, *_)

	async def srem(self, key, *members):
		return await self.protocol.send(b'SREM', key, *members)

	async def sunion(self, key, *other_keys):
		return await self.protocol.send(b'SUNION', key, *other_keys)
