...
class SortedSetMix(BaseMix):
	...
	async def zadd(self, key, *sms):
		...
		return await self.protocol.send(b'ZADD', key, *sms)

	async def zcard(self, key):
		return await self.protocol.send(b'ZCARD', key)

	async def zcount(self, key, min_v, max_v):
		return await self.protocol.send(b'ZCOUNT', key, min_v, max_v)

	async def zincrby(self, key, increment, member):
		return await self.protocol.send(b'ZINCRBY', key, increment, member)
	...
	async def zrange(self, key, start, stop, withscores=False):
		...
		return await self.protocol.send(b'ZRANGE', key, start, stop, *_)
	...
	async def zrangebyscore(self, key, min_v, max_v, withscores=False, offset=None, limit=None):
		...
		return await self.protocol.send(b'ZRANGEBYSCORE', key, min_v, max_v, *_)

	async def zrank(self, key, member):
		return await self.protocol.send('ZRANK', key, member)

	async def zrem(self, key, *members):
		assert members
		return await self.protocol.send(b'ZREM', key, *members)

	async def zremrangebyrank(self, key, start, stop):
		return await self.protocol.send(b'ZREMRANGEBYRANK', key, start, stop)

	async def zremrangebyscore(self, key, min_v, max_v):
		return await self.protocol.send(b'ZREMRANGEBYSCORE', key, min_v, max_v)
	...
	async def zrevrange(self, start, stop, withscores=False):
		...
		return await self.protocol.send(b'ZREVRANGE', start, stop, *_)
	...
	async def zrevrangebyscore(self, key, min_v, max_v, withscores=False, offset=None, limit=None):
		...
		return await self.protocol.send(b'ZREVRANGEBYSCORE', key, min_v, max_v, *_)

	async def zrevrank(self, key, member):
		return await self.protocol.send(b'ZREVRANK', key, member)

	async def zscore(self, key, member):
		return await self.protocol.send(b'ZSCORE', key, member)
	...
	async def zunionstore(self, destination, numberkeys, *keys, weights=None, aggregate=None):
		...
		return await self.protocol.send(b'ZUNIONSTORE', *_)
	...
	async def zinterstore(self, destination, numberkeys, *keys, weights=None, aggregate=None):
		...
		return await self.protocol.send(b'ZINTERSTORE', *_)
	...
	async def zrangebylex(self, key, min_v, max_v, offset=None, limit=None):
		...
		return await self.protocol.send(b'ZRANGEBYLEX', key, min_v, max_v, *_)

	async def zlexcount(self, key, min_v, max_v):
		return self.protocol.send(b'ZLEXCOUNT', key, min_v, max_v)

	async def zremrangebylex(self, key, min_v, max_v):
		return self.protocol.send(b'ZREMRANGEBYLEX', key, min_v, max_v)
